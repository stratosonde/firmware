...
#define LORAWAN_DEVICE_EUI_US915 0x60, 0x81, 0xF9, 0x53, 0x25, 0x20, 0x09, 0x15 // 915 MHz, Americas (counter=2)
...
#define LORAWAN_DEVICE_EUI_RU864 0x60, 0x81, 0xF9, 0x53, 0x25, 0x0E, 0x08, 0x64 // 864 MHz, Russia (SP-05 #246)
