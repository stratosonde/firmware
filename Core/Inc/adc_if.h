...
/**
  * @brief Maximum battery level in mV (5.5V for main battery)
  */
#define VDD_BAT                     ((uint32_t) 5500)
/**
  * @brief Minimum battery level in mV (3.3V for main battery)
  */
#define VDD_MIN                     ((uint32_t) 3300)
