 ...
 * @note   Was gated on ENABLE_GNSS_DETAIL_PACKET (FR-19/#100) when the debug
 *         packet was the sole producer; the version-report frame (A-005/#79)
 *         is a second producer, so Push is unconditional.
 */
