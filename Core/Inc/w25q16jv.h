...
/* JEDEC IDs accepted by W25Q_Init (exact match, F13/#174 whitelist).
 * W25Q16JV (2MB) is the flight part. W25Q80 (1MB) is accepted strictly as a
 * bench fallback for boards stuffed with the smaller BOM option - page,
...
typedef struct {
    ...
    uint32_t capacity_bytes;  /* Device capacity resolved at init (W25Q16/W25Q80) */
} W25Q_HandleTypeDef;
