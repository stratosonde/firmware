...
clean-Core-2f-Src:
	...
	-$(RM) ./Core/Src/first_flight_policy.cyclo ./Core/Src/first_flight_policy.d ./Core/Src/first_flight_policy.o ./Core/Src/first_flight_policy.su ./Core/Src/packet_queue.cyclo ./Core/Src/packet_queue.d ./Core/Src/packet_queue.o ./Core/Src/packet_queue.su ./Core/Src/nvm_slot.cyclo ./Core/Src/nvm_slot.d ./Core/Src/nvm_slot.o ./Core/Src/nvm_slot.su ./Core/Src/region_policy.cyclo ./Core/Src/region_policy.d ./Core/Src/region_policy.o ./Core/Src/region_policy.su ./Core/Src/gnss_acquire.cyclo ./Core/Src/gnss_acquire.d ./Core/Src/gnss_acquire.o ./Core/Src/gnss_acquire.su ./Core/Src/tx_fsm.cyclo ./Core/Src/tx_fsm.d ./Core/Src/tx_fsm.o ./Core/Src/tx_fsm.su
