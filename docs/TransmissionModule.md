...
3. **Silences** (executor, first veto wins — `TransmitVeto_t`, archived in the
   ...
   | 6 | `VETO_PRELAUNCH_QUIET` | commissioned-but-not-launched quiet watch (DR-06/#241) - RETIRED 2026-08-18 (COMM-TX privacy-safe commissioning telemetry, DDR-0002 §7); exit via the PB13 arming button (active-low to GND on the shared SPI2_SCK net, debounced across consecutive wakes — commissioning-only, no flash traffic) or pressure launch detection (PRETEST-DEC-01, #142) |
