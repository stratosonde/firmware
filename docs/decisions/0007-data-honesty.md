# DDR-0007: Data Honesty — Every Reading Carries Its Own Freshness
...
4. **Status byte restored to the compact uplink as byte 11** (DDR-0005 freed it: LinkCheck rides FOpts). Layout:
   ...
   - b6–b7 mission state (COMMISSIONING / ASCENT / FLOAT / reserved — see DDR-0008)
