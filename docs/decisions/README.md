...
7. **New 2026-08-13:** no reset-count/failure-history escalation may exist anywhere (DDR-0009 `OD-FAIL-006` resolved, DDR-0020). **2026-08-15:** implemented: the boot-attempt counter is diagnostic only; fatal calls always breadcrumb/reset and Tier-2 commit-back is never suppressed by reset history (FW-CONF-041).
